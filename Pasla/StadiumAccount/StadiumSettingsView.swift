...
struct StadiumSettingsView: View {
    ...
    var body: some View {
        NavigationView{
            VStack{
                ...
                .navigationTitle(Text("Ayarlar")).navigationBarTitleDisplayMode(.inline)
        }
...
struct StadiumSettingsView_Previews: PreviewProvider {
